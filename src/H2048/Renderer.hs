...
renderGameStartTip =
    translate (-190) (-10) $ scale 0.2 0.2 $ Text "Type SpaceKey to start game"
...
getTileBgColor tile = case tile of
    ...
    Tile 2 ->
        TileStyle (makeColorI 238 228 218 255) (makeColorI 119 110 101 255)
    Tile 4 ->
        TileStyle (makeColorI 237 224 200 255) (makeColorI 119 110 101 255)
